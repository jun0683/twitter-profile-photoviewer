...
- (NSString *)getHomeTimelineSinceID:(unsigned long)sinceID startingAtPage:(int)page count:(int)count; // statuses/home_timeline
{
	return [self getHomeTimelineSinceID:sinceID withMaximumID:0 startingAtPage:page count:count];
}

- (NSString *)getHomeTimelineSinceID:(unsigned long)sinceID withMaximumID:(unsigned long)maxID startingAtPage:(int)page count:(int)count; // statuses/home_timeline
{
